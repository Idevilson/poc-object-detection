...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::facerecognizer::Rect> final {
    static inline margelo::nitro::facerecognizer::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::facerecognizer::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::facerecognizer::Rect& arg) {
