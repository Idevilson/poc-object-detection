...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::facerecognizer::Point> final {
    static inline margelo::nitro::facerecognizer::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::facerecognizer::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::facerecognizer::Point& arg) {
